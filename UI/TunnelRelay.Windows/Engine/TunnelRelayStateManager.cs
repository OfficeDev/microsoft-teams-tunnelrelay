...
namespace TunnelRelay.Windows.Engine
{
  ...
  internal static class TunnelRelayStateManager
  {
    ...
    /// <summary>
    /// The relay manager, reposible for relaying RelayRequsts to downstream host.
    /// </summary>
    private static IRelayRequestManager relayManagerClasslevelVariable;
    ...
    /// <summary>
    /// Gets Relay Manager which can re-issue previously captured relays.
    /// </summary>
    public static IRelayRequestManager RelayManager => relayManagerClasslevelVariable;
...
#pragma warning restore CA5400 // Ensure HttpClient certificate revocation list check is not disabled - Allowing developers to use invalid certificates
      ...
      relayManagerClasslevelVariable = relayManager;
